...
def main():
    parser = argparse.ArgumentParser(description='Generate uBlacklist subscription file')
    parser.add_argument('--output', '-o', default='blocklist.txt', help='Output file')
    parser.add_argument('--sources', required=True, help='Path to sources configuration file')
